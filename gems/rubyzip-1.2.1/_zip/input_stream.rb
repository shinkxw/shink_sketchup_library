module Shink::BaseLibrary::Zip
  ...
  class InputStream
    ...
    def initialize(context, offset = 0, decrypter = nil)
      ...
      @decrypter     = decrypter || NullDecrypter.new
      @current_entry = nil
    end
    ...
    def open_entry
      @current_entry = Entry.read_local_entry(@archive_io)
      ...
      if @current_entry && @current_entry.gp_flags & 8 == 8 && @current_entry.crc == 0 \
        ...
        raise GPFBit3Error,
              ...
              'Please use File instead of InputStream'
      end
    ...
    def get_decompressor
      ...
      when @current_entry.nil?
        NullDecompressor
      when @current_entry.compression_method == Entry::STORED
        PassThruDecompressor.new(@archive_io, @current_entry.size)
      when @current_entry.compression_method == Entry::DEFLATED
        header = @archive_io.read(@decrypter.header_bytesize)
        @decrypter.reset!(header)
        Inflater.new(@archive_io, @decrypter)
      else
