  ...
  class File < CentralDirectory
    ...
    class << self
      ...
      def open_buffer(io, options = {})
        ...
        zf = File.new(io, true, true, options)
    ...
    def add(entry, src_path, &continue_on_exists_proc)
      ...
      new_entry = entry.kind_of?(Entry) ? entry : Entry.new(@name, entry.to_s)
    ...
    def commit
      ...
      on_success_replace do |tmp_file|
        OutputStream.open(tmp_file) do |zos|
          @entry_set.each do |e|
